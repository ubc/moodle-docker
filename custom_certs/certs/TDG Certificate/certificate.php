...
certificate_print_text($pdf, 35, $y + 180, 'L', 'freesans', '', 18,  "For TDG by ground, expires on: " . $expiry_date_ground);
certificate_print_text($pdf, 35, $y + 190, 'L', 'freesans', '', 18,  "For TDG by air, expires on: " . $expiry_date_air);
