			...
			<div class="maintable container">
				<div class="center" style="width:100%; padding-top:20px; padding-bottom:20px;">
					<div class="col rightborder">
						...
						<div class="center l">
							UBC faculty, staff, and students with a CWL:<a href="/auth/shibboleth/index.php">
						</div>
						<div class="center">
							<img src="./files/cwl_login.png" alt="" width="83" height="35" /></a>
						</div>
					</div>
					<div class="col">
						<div class="center l">
						...
						<div class="center l" style=" line-height:2.5;">
								...
								<div style="height:60px; vertical-align:middle;">Cookies must be enabled in your browser</div>
						</div>
					</div>
				</div>
			</div>
