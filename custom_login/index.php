...
<body>
    <div class="container">
        ...
        <div id="ubc7-unit" class="row-fluid expand">
            <div class="span12">
                <!-- Mobile Menu Icon -->
				<div id="ubc7-unit-name" class="ubc7-single-element"><a href="https://rms.ubc.ca/" title="Safety & Risk Services"><span id="ubc7-unit-faculty">Safety & Risk Services</span><span id="ubc7-unit-identifier">Safety & Risk Services</span></a></div>
            </div>
        </div>
